...
//	@Test
	void saveGaragetest() {
		...
		GarageRecorder recorder = new GarageRecorder();
		recorder.saveGarage(garage);
	...
	void loadGarageTest() {
		GarageRecorder recorder = new GarageRecorder();
		Garage garage = recorder.loadGarage();
		assertEquals(garage.getPersonnelManager().getAttendants().get("Eddie").getAttendantPassword(), "dfrtyu");
		
		garage.checkOutVehicle("EEOI4885", "Sarah");
